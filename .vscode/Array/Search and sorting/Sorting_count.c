...
int main()
{
    ...
    if(count==n)
    {
        printf("The possible increase sorting order comes at real order without rotation");
    ...
    {
        printf("The possible increase sorting order comes at the %d th time of rotation",count);
        ...
        printf("..");
        printf("\n The possible increase sorting order of array is ");
        for(int i=0;i<n;i++)
        {
            printf(" %d,",t[i]);
        }
